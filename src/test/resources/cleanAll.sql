...
CREATE TABLE IF NOT EXISTS `test_concertPlanner`.`Instrument_Category` (`id` INT(11) NOT NULL AUTO_INCREMENT, `category` VARCHAR(100) NOT NULL, PRIMARY KEY (`id`)) ENGINE = InnoDB AUTO_INCREMENT = 21 DEFAULT CHARACTER SET = latin1;
...
START TRANSACTION;
USE `test_concertPlanner`;
INSERT INTO `test_concertPlanner`.`Musician` (`id`, `first_name`, `last_name`, `phone_number`, `email`, `status`) VALUES (1, 'Sean', 'Kleve', '123', 'sean@clocksinmotionpercussion.com', 'Active');
INSERT INTO `test_concertPlanner`.`Musician` (`id`, `first_name`, `last_name`, `phone_number`, `email`, `status`) VALUES (2, 'Matthew', 'Coley', '123', 'matthew@clocksinmotionpercussion.com', 'Active');
INSERT INTO `test_concertPlanner`.`Musician` (`id`, `first_name`, `last_name`, `phone_number`, `email`, `status`) VALUES (3, 'Andrew', 'Viet', '123', 'matthew@clocksinmotionpercussion.com', 'Active');
INSERT INTO `test_concertPlanner`.`Musician` (`id`, `first_name`, `last_name`, `phone_number`, `email`, `status`) VALUES (4, 'Kyle', 'Flens', '123', 'matthew@clocksinmotionpercussion.com', 'Substitute');
INSERT INTO `test_concertPlanner`.`Musician` (`id`, `first_name`, `last_name`, `phone_number`, `email`, `status`) VALUES (5, 'Garrett', 'Mendelow', '123', 'matthew@clocksinmotionpercussion.com', 'Inactive');
COMMIT;
START TRANSACTION;
USE `test_concertPlanner`;
...
INSERT INTO `test_concertPlanner`.`Composition` (`Id`, `title`, `arranger`, `duration`, `year`, `clocks_commission`, `number_of_players`, `notes`, `Composer_Id`) VALUES (4, 'title', 'arranger', 1, 2019, 1, 4, 'notes', 2);
INSERT INTO `test_concertPlanner`.`Composition` (`Id`, `title`, `arranger`, `duration`, `year`, `clocks_commission`, `number_of_players`, `notes`, `Composer_Id`) VALUES (5, 'title', 'arranger', 1, 2019, 0, 4, 'notes', 3);
COMMIT;
START TRANSACTION;
USE `test_concertPlanner`;

...
<<<<<<< HEAD
CREATE TABLE IF NOT EXISTS `test_concertPlanner`.`Program` (`id` INT(11) NOT NULL AUTO_INCREMENT, `date` DATE NOT NULL, `title` VARCHAR(100) NOT NULL, `location` VARCHAR(100) NOT NULL, `address` VARCHAR(100) NOT NULL, `city` VARCHAR(100) NOT NULL, `state` VARCHAR(2) NOT NULL, user_Id int(11) NOT NULL, PRIMARY KEY (`id`)) ENGINE = InnoDB DEFAULT CHARACTER SET = latin1;
=======
